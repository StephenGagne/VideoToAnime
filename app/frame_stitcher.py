...
def stitch_frames(videoName,videoPath, audioPath):
    ...
    merge_audio_to_video(temp_video_file, audioPath, output_video_file)
...
if __name__ == "__main__":
    ...
    stitch_frames(video_name, video_path, audio_path)